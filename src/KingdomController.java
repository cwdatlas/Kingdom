...
public class KingdomController extends JPanel
	...
	public KingdomController(JFrame parentPanel) {
		setVariables(); //sets the variables that will need to be reset when the user wants to play again
		parent = parentPanel;
	...
	public void paintComponent(Graphics g) {
		...
		playAgain.setBounds((int)(youDiedWindow.getWidth()*.3), (int)(youDiedWindow.getHeight()*.8), (int)(youDiedWindow.getWidth()*.4), (int)(youDiedWindow.getHeight()*.1));
		...
		livingDefenders.setBounds((int)(youDiedWindow.getWidth()*.01), 60, (int)(youDiedWindow.getWidth()*.4), 20);
